...
<div class="flex sm:mt-4 justify-center" style="height:500px">
    <object data="{{asset('pdf/layoutrulesgo275.pdf')}}#toolbar=0" type="application/pdf" width="100%" height="100%">
  <p>Your web browser doesn't have a PDF plugin.
  Instead you can <a href="{{asset('pdf/layoutrulesgo275.pdf')}}" class="font-bold">click here to
