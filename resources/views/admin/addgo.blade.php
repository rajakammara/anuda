                    ...
                    <div class="sm:mt-4">
                        <form class="">
                            <div class="flex flex-row items-center space-x-2">
                                ...
                                <div class="w-2/4"><input type="text"
                                        class="focus:border-gray-100 rounded-md p-2 m-2 w-full" /></div>
                            </div>
                            ...
                            <div class="flex flex-row items-center space-x-2">
                                ...
                                <div class="w-2/4"><textarea class="focus:border-gray-100 rounded-md m-2 w-full"> </textarea></div>
                            </div>
                            ...
                            <div class="flex flex-row items-center space-x-2">
                                ...
                                <div class="w-2/4"><input type="file"
                                        class="focus:border-gray-100 rounded-md p-2 m-2 w-full" /></div>
                            </div>
                            <div class="flex flex-row items-center space-x-2">
                                <div class="w-1/4">
