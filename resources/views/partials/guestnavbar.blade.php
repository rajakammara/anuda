<nav x-data="{ open: false }" class="bg-blue-600 border-b border-t border-blue-200">
    <div class="hidden md:flex justify-center font-bold">
        ...
        <div class="hidden sm:flex sm:items-center sm:ml-2 hover:bg-blue-800 ">
            <x-anuda.dropdown align="top" width="44">
                <x-slot name="trigger">
                    <button
                        class="flex items-center font-bold text-white hover:border-gray-300 focus:outline-none focus:text-white focus:border-gray-300 transition duration-150 ease-in-out w-32 justify-center">
                        <div>Planning</div>
    ...
    <div class="flex justify-between items-center sm:hidden p-2">
        <div class="text-white font-bold flex items-center space-x-1"><img src={{ asset('images/logo.png') }}
                class="w-10 object-contain mr-2" />ANUDA</div>
            ...
            <div class="pt-4 pb-1 border-t border-gray-200">
                <div class="flex items-center px-4">
                    <div class="flex-shrink-0">
                        <svg class="h-10 w-10 fill-current text-gray-100" xmlns="http://www.w3.org/2000/svg" fill="none"
